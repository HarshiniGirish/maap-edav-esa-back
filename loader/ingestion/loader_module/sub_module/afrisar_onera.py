...
class AfrisarOneraLoader(CMRLoader):
    ...
    def load(self, json_feature,datasetlist):
        try:
            ...
            if product == "ROI":
                ...
                scenetype,scene_value,subregion,subregion_value,wcs_val = self.getSceneparams(scene_name,datasetlist [ 0 ][ "title" ],["LA LOPE","MABOUNIE","MONDAH","RABI"])
            else:
