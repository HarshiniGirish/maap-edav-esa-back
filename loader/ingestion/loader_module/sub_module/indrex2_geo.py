...
class Indrex2GeoLoader(CMRLoader):
    ...
    def getList(self):
        ...
        for obj in bucket.objects.filter( Prefix = "edav_prepocessed_data/indrex2" ):
    ...
    def load(self, filename,datasetlist):
        ...
        try:
            ...
            if r.status_code==200 and r.json()["hits"]==1:
                ...
                scenetype,scene_value,subregion, subregion_value ,wcs_val= self.getSceneparams(self.extractAttributes(json_feature["umm"]["AdditionalAttributes"],"Scene Name"),datasetlist [ 0 ][ "title" ],["SAMBOJA LESTARI","SUNGAI WAIN (NORTH)","SUNGAI WAIN (SOUTH)","MAWAS-A","MAWAS-C","MAWAS-E","MERATUS"])
