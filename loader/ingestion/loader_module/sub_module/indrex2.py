    ...
    def load(self, json_feature,datasetlist):
        try:
            ...
            if product == "ROI":
                ...
                scenetype,scene_value,subregion,subregion_value,wcs_val = self.getSceneparams(scene_name,datasetlist [ 0 ][ "title" ],["SAMBOJA LESTARI","SUNGAI WAIN (NORTH)","SUNGAI WAIN (SOUTH)","MAWAS-A","MAWAS-C","MAWAS-E","MERATUS"])
            else:
